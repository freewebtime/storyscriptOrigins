...
;
__context['__text'] = [...__context['__text'], `\t  * Подпеременная \//Ошибка! Значение переменной "Переменная" - это цифра, у нее не может быть вложенных переменных`];
;
__context['__text'] = [...__context['__text'], ``];
;
...
;
__context['__text'] = [...__context['__text'], `${__serializer.serialize(__context['фото'](`inserted_imported_character.png`, `import characters`), '\r\n')}`];
;
__context['__text'] = [...__context['__text'], ``];
;
__context['__text'] = [...__context['__text'], ``];
