...
;
__context['__text'] = [...__context['__text'], `Актуально для версий 0.0.x. Примите во внимание, что Storytailor работает в экспериментальном режиме, и некоторые правила могут быть в дальнейшем изменены`];
;
__context['__text'] = [...__context['__text'], ``];
;
__context['__text'] = [...__context['__text'], `Это - краткая инструкция пользователя языка программирования ${__serializer.serialize( __context['ссылка'](`https://github.com/jack-storytailor/storytailor`, `Storytailor`), '\r\n' )} в ${__serializer.serialize( __context['ссылка'](`https:\//code.visualstudio.com/`, `Microsoft Visual Studio Code`), '\r\n' )}`];
;
__context['__text'] = [...__context['__text'], ``];
;
...
__context['__text'] = [...__context['__text'], ``];
;
__context['__text'] = [...__context['__text'], `Установите ${__serializer.serialize( __context['ссылка'](`https://marketplace.visualstudio.com/items?itemName=jackstorytailor.storytailor-vscode`, `Storytailor плагин для vscode`), '\r\n' )}`];
;
...
;
__context['__text'] = [...__context['__text'], `Storytailor задуман как диалект javascript по аналогии с ${__serializer.serialize( __context['ссылка'](`https:\//www.typescriptlang.org/`, `typescript`), '\r\n' )}.`];
;
...
__context['__text'] = [...__context['__text'], ``];
;
__context['__text'] = [...__context['__text'], `\t-> storytailor`];
;
__context['__text'] = [...__context['__text'], `\t* {`];
;
